...
I = VideoReader('KTH Dataset\hand_clap1.avi');
%implay('KTH Dataset\hc1.avi');
%pause(0.3);
...
%delete('Train_Features\Train_Feat1.mat');
 filename = fullfile('C:\MATLAB\ARC\Train_features\Train_Feat1.mat');  
 save(filename,'Train_Feat');
 filename = fullfile('C:\MATLAB\ARC\Train_features\label1.mat');  
 save(filename,'label');